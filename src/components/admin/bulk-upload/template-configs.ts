...
export const TEMPLATE_CONFIGS: Record<string, ModuleTemplateConfig> = {
  ...
  practice: {
    ...
    columns: [
      {
        ...
        type: "string",
        required: true,
        description: "Name of the Module/Chapter (e.g. 'Java Basics', 'Java OOP'). Multiple questions with the same Module Name will be grouped together into a single module containing all of those questions.",
    ...
    sampleRows: [
      // ── MODULE 1: Java Basics (10 Questions) ─────────────────────────────────
      { moduleName: "Java Basics", title: "What is Java?", type: "coding", difficulty: "Easy", totalMarks: 10, durationMinutes: 60, description: "Write a program that prints 'Java is a robust, object-oriented language'.", testcase_1_input: "", testcase_1_output: "Java is a robust, object-oriented language", hidden_testcase_input: "", hidden_testcase_output: "Java is a robust, object-oriented language" },
      { moduleName: "Java Basics", title: "What is JVM?", type: "coding", difficulty: "Easy", totalMarks: 10, durationMinutes: 60, description: "Write a program that demonstrates Java Virtual Machine architecture fundamentals.", testcase_1_input: "jvm", testcase_1_output: "Bytecode Interpreter", hidden_testcase_input: "jvm_arch", hidden_testcase_output: "Bytecode Interpreter" },
      { moduleName: "Java Basics", title: "What is JDK?", type: "coding", difficulty: "Easy", totalMarks: 10, durationMinutes: 60, description: "Write a program demonstrating Java Development Kit tools.", testcase_1_input: "jdk", testcase_1_output: "Development Tools", hidden_testcase_input: "compiler", hidden_testcase_output: "javac" },
      { moduleName: "Java Basics", title: "What is JRE?", type: "coding", difficulty: "Easy", totalMarks: 10, durationMinutes: 60, description: "Write a program illustrating Java Runtime Environment components.", testcase_1_input: "jre", testcase_1_output: "Runtime Environment", hidden_testcase_input: "runtime", hidden_testcase_output: "Runtime Environment" },
      { moduleName: "Java Basics", title: "What is a Variable?", type: "coding", difficulty: "Easy", totalMarks: 10, durationMinutes: 60, description: "Declare an integer variable 'count' with value 42 and print it.", testcase_1_input: "", testcase_1_output: "42", hidden_testcase_input: "", hidden_testcase_output: "42" },
      { moduleName: "Java Basics", title: "What are Data Types?", type: "coding", difficulty: "Easy", totalMarks: 10, durationMinutes: 60, description: "Read a float and an integer, print their sum as a double.", testcase_1_input: "3.5 4", testcase_1_output: "7.5", hidden_testcase_input: "10.25 5", hidden_testcase_output: "15.25" },
      { moduleName: "Java Basics", title: "What are Operators?", type: "coding", difficulty: "Easy", totalMarks: 10, durationMinutes: 60, description: "Given two numbers a and b, compute and print a % b.", testcase_1_input: "10 3", testcase_1_output: "1", hidden_testcase_input: "25 7", hidden_testcase_output: "4" },
      { moduleName: "Java Basics", title: "What is Type Casting?", type: "coding", difficulty: "Easy", totalMarks: 10, durationMinutes: 60, description: "Convert a double to an integer via explicit casting and print it.", testcase_1_input: "9.99", testcase_1_output: "9", hidden_testcase_input: "45.75", hidden_testcase_output: "45" },
      { moduleName: "Java Basics", title: "What is a Loop?", type: "coding", difficulty: "Easy", totalMarks: 10, durationMinutes: 60, description: "Given integer N, print numbers from 1 to N separated by a space.", testcase_1_input: "5", testcase_1_output: "1 2 3 4 5", hidden_testcase_input: "3", hidden_testcase_output: "1 2 3" },
      { moduleName: "Java Basics", title: "What is an Array?", type: "coding", difficulty: "Easy", totalMarks: 10, durationMinutes: 60, description: "Given N elements, print the first and last element separated by space.", testcase_1_input: "4\n10 20 30 40", testcase_1_output: "10 40", hidden_testcase_input: "3\n5 15 25", hidden_testcase_output: "5 25" },

      // ── MODULE 2: Java OOP (10 Questions) ────────────────────────────────────
      { moduleName: "Java OOP", title: "What is a Class?", type: "coding", difficulty: "Easy", totalMarks: 10, durationMinutes: 60, description: "Create a Student class with name and age fields, instantiate and print details.", testcase_1_input: "Alice 20", testcase_1_output: "Student: Alice, Age: 20", hidden_testcase_input: "Bob 22", hidden_testcase_output: "Student: Bob, Age: 22" },
      { moduleName: "Java OOP", title: "What is an Object?", type: "coding", difficulty: "Easy", totalMarks: 10, durationMinutes: 60, description: "Instantiate an object and invoke its greet method.", testcase_1_input: "World", testcase_1_output: "Hello, World!", hidden_testcase_input: "Java", hidden_testcase_output: "Hello, Java!" },
      { moduleName: "Java OOP", title: "What is Inheritance?", type: "coding", difficulty: "Medium", totalMarks: 10, durationMinutes: 60, description: "Demonstrate single inheritance with Animal base class and Dog derived class.", testcase_1_input: "Buddy", testcase_1_output: "Dog Buddy barks", hidden_testcase_input: "Max", hidden_testcase_output: "Dog Max barks" },
      { moduleName: "Java OOP", title: "What is Polymorphism?", type: "coding", difficulty: "Medium", totalMarks: 10, durationMinutes: 60, description: "Demonstrate runtime polymorphism by overriding the draw() method.", testcase_1_input: "Circle", testcase_1_output: "Drawing Circle", hidden_testcase_input: "Square", hidden_testcase_output: "Drawing Square" },
      { moduleName: "Java OOP", title: "What is Encapsulation?", type: "coding", difficulty: "Easy", totalMarks: 10, durationMinutes: 60, description: "Create a BankAccount class with private balance and public getter/setter.", testcase_1_input: "500", testcase_1_output: "Balance: 500", hidden_testcase_input: "1200", hidden_testcase_output: "Balance: 1200" },
      { moduleName: "Java OOP", title: "What is Abstraction?", type: "coding", difficulty: "Medium", totalMarks: 10, durationMinutes: 60, description: "Define an abstract class Shape with abstract method area().", testcase_1_input: "4 5", testcase_1_output: "Area: 20", hidden_testcase_input: "6 7", hidden_testcase_output: "Area: 42" },
      { moduleName: "Java OOP", title: "What is Constructor?", type: "coding", difficulty: "Easy", totalMarks: 10, durationMinutes: 60, description: "Implement a parameterized constructor to initialize object coordinates.", testcase_1_input: "3 4", testcase_1_output: "Point(3, 4)", hidden_testcase_input: "8 9", hidden_testcase_output: "Point(8, 9)" },
      { moduleName: "Java OOP", title: "What is Method Overloading?", type: "coding", difficulty: "Easy", totalMarks: 10, durationMinutes: 60, description: "Overload add() to handle both two integers and three integers.", testcase_1_input: "2 3\n1 2 3", testcase_1_output: "5\n6", hidden_testcase_input: "5 5\n2 3 4", hidden_testcase_output: "10\n9" },
      { moduleName: "Java OOP", title: "What is Method Overriding?", type: "coding", difficulty: "Medium", totalMarks: 10, durationMinutes: 60, description: "Override sound() method in sub-class Cat returning 'Meow'.", testcase_1_input: "cat", testcase_1_output: "Meow", hidden_testcase_input: "cat2", hidden_testcase_output: "Meow" },
      { moduleName: "Java OOP", title: "What is Interface?", type: "coding", difficulty: "Medium", totalMarks: 10, durationMinutes: 60, description: "Implement Printable interface with print() method.", testcase_1_input: "Document", testcase_1_output: "Printing Document", hidden_testcase_input: "Invoice", hidden_testcase_output: "Printing Invoice" },

      // ── MODULE 3: Java Arrays (10 Questions) ─────────────────────────────────
      { moduleName: "Java Arrays", title: "Declare and Initialize an Array", type: "coding", difficulty: "Easy", totalMarks: 10, durationMinutes: 60, description: "Initialize an array of size N and print its elements.", testcase_1_input: "3\n1 2 3", testcase_1_output: "1 2 3", hidden_testcase_input: "2\n7 8", hidden_testcase_output: "7 8" },
      { moduleName: "Java Arrays", title: "Find Maximum in Array", type: "coding", difficulty: "Easy", totalMarks: 10, durationMinutes: 60, description: "Find and return the maximum element in the given integer array.", testcase_1_input: "5\n3 1 9 4 2", testcase_1_output: "9", hidden_testcase_input: "4\n-5 -2 -10 -1", hidden_testcase_output: "-1" },
      { moduleName: "Java Arrays", title: "Find Minimum in Array", type: "coding", difficulty: "Easy", totalMarks: 10, durationMinutes: 60, description: "Find and return the minimum element in the given integer array.", testcase_1_input: "5\n3 1 9 4 2", testcase_1_output: "1", hidden_testcase_input: "4\n10 20 5 40", hidden_testcase_output: "5" },
      { moduleName: "Java Arrays", title: "Reverse an Array", type: "coding", difficulty: "Easy", totalMarks: 10, durationMinutes: 60, description: "Reverse an array in-place and print the reversed elements.", testcase_1_input: "4\n1 2 3 4", testcase_1_output: "4 3 2 1", hidden_testcase_input: "3\n9 8 7", hidden_testcase_output: "7 8 9" },
      { moduleName: "Java Arrays", title: "Check if Array is Sorted", type: "coding", difficulty: "Easy", totalMarks: 10, durationMinutes: 60, description: "Return true if the array is sorted in non-decreasing order, else false.", testcase_1_input: "4\n1 2 2 3", testcase_1_output: "true", hidden_testcase_input: "4\n1 3 2 4", hidden_testcase_output: "false" },
      { moduleName: "Java Arrays", title: "Two Sum Problem", type: "coding", difficulty: "Easy", totalMarks: 10, durationMinutes: 60, description: "Find indices of the two numbers that add up to target.", testcase_1_input: "2 7 11 15\n9", testcase_1_output: "0 1", hidden_testcase_input: "3 2 4\n6", hidden_testcase_output: "1 2" },
      { moduleName: "Java Arrays", title: "Move Zeroes to End", type: "coding", difficulty: "Medium", totalMarks: 10, durationMinutes: 60, description: "Move all zeroes in an array to the end while maintaining relative order of non-zeroes.", testcase_1_input: "5\n0 1 0 3 12", testcase_1_output: "1 3 12 0 0", hidden_testcase_input: "3\n0 0 1", hidden_testcase_output: "1 0 0" },
      { moduleName: "Java Arrays", title: "Remove Duplicates from Sorted Array", type: "coding", difficulty: "Easy", totalMarks: 10, durationMinutes: 60, description: "Remove duplicates in-place from sorted array and return new length.", testcase_1_input: "3\n1 1 2", testcase_1_output: "2", hidden_testcase_input: "5\n0 0 1 1 2", hidden_testcase_output: "3" },
      { moduleName: "Java Arrays", title: "Rotate Array by K Positions", type: "coding", difficulty: "Medium", totalMarks: 10, durationMinutes: 60, description: "Rotate array to the right by K steps.", testcase_1_input: "5 2\n1 2 3 4 5", testcase_1_output: "4 5 1 2 3", hidden_testcase_input: "4 1\n1 2 3 4", hidden_testcase_output: "4 1 2 3" },
      { moduleName: "Java Arrays", title: "Linear Search in Array", type: "coding", difficulty: "Easy", totalMarks: 10, durationMinutes: 60, description: "Search for key K in array. Return index if found, else -1.", testcase_1_input: "4 30\n10 20 30 40", testcase_1_output: "2", hidden_testcase_input: "3 50\n10 20 30", hidden_testcase_output: "-1" }
    ],
    mapToPayload: (row, idx) => {
      const parentMod = String(row.moduleName || row.module_name || row.title || `Module ${idx + 1}`).trim();
