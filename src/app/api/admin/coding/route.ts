...
// POST /api/admin/coding - Save or update coding problem in Supabase DB
export async function POST(request: NextRequest) {
  try {
    const supabase = createAdminClient();
    const problem = (await request.json()) as CodingProblem;
    ...
    return NextResponse.json({ success: true, problem: savedProblem });
  } catch (error: any) {
