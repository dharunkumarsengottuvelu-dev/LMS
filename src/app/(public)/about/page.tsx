...
const sensilearnCommitments = [
  { letter: "S", name: "Skill-Driven", desc: "Purpose-driven and learner-centric throughout the journey." },
  { letter: "E", name: "Evolutionary", desc: "Designed to evolve with learner needs and industry changes." },
  { letter: "N", name: "Next-Gen", desc: "Powered by modern technologies and outcome-oriented methodologies." },
  { letter: "S", name: "Structured", desc: "Systematic, measurable, and seamless to navigate." },
  { letter: "I", name: "Intelligent", desc: "Connecting foundational concepts with practical execution." },
  { letter: "L", name: "Learner-Centric", desc: "Built around relevant, structured, and high-impact learning content." },
];
      ...
      <section className="pt-36 pb-20 px-4 sm:px-6 lg:px-8 text-center bg-gradient-to-b from-primary/10 via-background to-background border-b border-border">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            SensiLearn is a next-generation learning and technology-driven training company under <strong>SENSI Group of Companies</strong>, built to bridge academic education and real-world career readiness.
          </p>
