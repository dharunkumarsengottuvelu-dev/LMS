      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full space-y-6">
        ...
        <TabsContent value={activeTab} className="w-full mt-6">
          {filteredAssignments.length === 0 ? (
            <div className="bg-white dark:bg-[#18181B] border border-slate-200/80 dark:border-zinc-800 p-12 text-center rounded-2xl w-full shadow-xs">
              <div className="w-14 h-14 rounded-2xl bg-blue-50 dark:bg-blue-950/40 border border-blue-200/60 dark:border-blue-900/50 flex items-center justify-center mx-auto mb-4 text-blue-600 dark:text-blue-400">
                <FileText className="h-7 w-7" />
              </div>
              <h3 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white">No Assignments Assigned Yet</h3>
              <p className="text-xs sm:text-sm text-slate-500 dark:text-zinc-400 max-w-md mx-auto mt-1 leading-relaxed">
