...
export class AIFaceTracker {
  ...
  public async analyzeFrame(
    ...
    // 1. Luminance & Lighting Analysis (subsampled every 8th pixel for enterprise performance)
    ...
    const avgLuminance = sampledPixels > 0 ? totalLuminance / sampledPixels : 128;
